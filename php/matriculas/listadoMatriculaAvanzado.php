...
//Datos de busqueda
$sql = "select * from matriculas where ".$oMatricula->clave." LIKE '%".$oMatricula->valor."%'";
...
$objeto_salida = array ("prueba" => $sql, "mensaje" => "Listado de Matriculas" , "resultado" => $datos, "accion" => 400, "error" => FALSE );
