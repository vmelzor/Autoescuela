...
//Datos de busqueda
$sql = "SELECT ID_MATRICULA AS 'ID MATRICULA',CANTIDAD_ABONADA AS 'CANTIDAD ABONADA',FECHA,PRACTICO_APROBADO AS 'PRACTICO APROBADO',TEORICO_APROBADO AS 'TEORICO APROBADO',PRECIO,DNI_CLIENTE AS 'DNI CLIENTE' from matriculas";
