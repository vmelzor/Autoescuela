...
//Datos de busqueda
$sql = "SELECT ID_MATRICULA AS 'ID MATRICULA',CANTIDAD_ABONADA AS 'CANTIDAD ABONADA',FECHA,PRACTICO_APROBADO AS 'PRACTICO APROBADO',TEORICO_APROBADO AS 'ID TEORICO APROBADO',PRECIO,DNI_CLIENTE AS 'DNI CLIENTE' from matriculas";
...
$objeto_salida = array ("mensaje" => "Listado de matriculas" , "resultado" => $datos, "accion" => 400, "error" => FALSE );
