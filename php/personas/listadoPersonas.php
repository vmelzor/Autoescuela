...
//Datos de busqueda
$sql = "select `DNI`,`NOMBRE`,`APELLIDOS`,`DIRECCION`,`EMAIL`,`TELEFONO`, case when `TIPO` = 'P' then 'Profesor' when `TIPO` = 'C' then 'Cliente' end as `TIPO` from personas";
...
$objeto_salida = array ("mensaje" => "Listado de personas" , "resultado" => $datos, "accion" => 400, "error" => FALSE );
